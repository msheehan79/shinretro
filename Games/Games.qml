...
FocusScope {
    ...
    function getAvailableSortFields() {
        ...
        // Excludes System and Dynamic Genre/Release Year Collections as custom sorting probably wouldn't make sense anyway
        var excludedCollectionTypes = ['System', 'Genre', 'Release Year'];
        if (root.state === "games" && !excludedCollectionTypes.includes(currentCollection.extra.collectiontype)) {
